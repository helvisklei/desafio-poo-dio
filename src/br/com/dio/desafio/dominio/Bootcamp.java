...
public class Bootcamp {
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataIncial, descricao, devsInscritos, nome);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				&& Objects.equals(dataIncial, other.dataIncial) && Objects.equals(descricao, other.descricao)
